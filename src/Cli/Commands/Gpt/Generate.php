...
class Generate implements CliCommandInterface
{
    ...
    public function process(Cli $cli, array $args):void
    {
        ...
        // Set message
        $tbl_prefix = "'" . str_replace("-", "_", $pkg->getAlias()) . "_'";
        $message = "In SQL, write mySQL database schema for $prompt, prefix all table names with $tbl_prefix, ensure all tables have a column named \"id\" with the type \"INT NOT NULL AUTO_INCREMENT\" column for all primary key columns, and write the results in SQL code.  Return only SQL code with no other dialog or conversation.";
        ...
        $files = $this->gpt_helper->processSqlSchema($pkg, $sql);
    ...
    public function help(Cli $cli):CliHelpScreen
    {
        ...
        $help->addExample("./apex gpt generate my-shop");
