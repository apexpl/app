 ...
 * Create collection
 */
class Collection implements CliCommandInterface
{
    ...
    public function process(Cli $cli, array $args):void
    {
        ...
        // Build
        $file = $this->opus->buildClass('collection', $filename, $item_class, SITE_PATH);

        // Success message
        $cli->success("Successfully created new collection which is now available at:", [$file]);
    }
