 ...
 * Create stack
 */
class Stack implements CliCommandInterface
{
    ...
    public function process(Cli $cli, array $args):void
    {
        ...
        // Build
        $file = $this->opus->buildClass('stack', $filename, $item_class, SITE_PATH);

        // Success message
        $cli->success("Successfully created new stack which is now available at:", [$file]);
    }
    ...
    public function help(Cli $cli):CliHelpScreen
    {
        ...
        $help = new CliHelpScreen(
            ...
            usage: 'opus stack <FILENAME> --item-class=<ITEM_CLASS>',
            description: 'Generate a new stack class.'
        );

        // Params
        $help->addParam('filename', 'File location of the new stack class, relative to the /src/ directory.');
        $help->addFlag('--item-class', 'The filepath to the item class.');

        // Examples
        $help->addExample('./apex opus stack MyShop/ProductIterator --item-class Demo/Models/Product');
