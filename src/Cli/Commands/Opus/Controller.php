 ...
 * Create collection
 */
class Controller implements CliCommandInterface
{
    ...
    public function process(Cli $cli, array $args):void
    {
        ...
        // Build
        $file = $this->opus->buildClass('controller', $filename, $item_class, SITE_PATH);

        // Success message
        $cli->success("Successfully created new controller which is now available at:", [$file]);
    }
