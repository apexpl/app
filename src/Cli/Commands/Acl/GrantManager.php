 ...
 */
class GrantManager implements CliCommandInterface
{
    ...
    public function process(Cli $cli, array $args):void
    {
        ...
        $res = $this->network->post($repo, 'acl/grant_manager', [
            'username' => $username
        ]);

        // Success
        $cli->send("Successfully granted manager access to user '$username'.\r\n\r\n");
    }
