...
class crud
{
    ...
    private array $code_templates = [
        ...
        'view_admin_manage_tpl' => '', 
...
private     function create_table(array $table, string $manage_uri = '')
{
    ...
    $code = str_replace("~rows_per_page~", (string) $rows_per_page, $code);
